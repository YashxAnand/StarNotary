...
contract StarNotary is ERC721 {
    ...
    struct Star {
     ...
     constructor() ERC721("Star Notary Service","SN") {
	 _name = "Star Notary Service";
	 _symbol = "SN";
     }
	...
	if(ownerOf(_tokenId1) == msg.sender){
	    _transfer(msg.sender, ownerOf(_tokenId2), _tokenId1);
	}else{
	    _transfer(msg.sender, ownerOf(_tokenId1), _tokenId2);
	}
    }
	...
	require(msg.sender == ownerOf(_tokenId), "Can't transfer token since owner of token is not the sender!");
